...
Android 8.0+（iOS / HarmonyOS 规划中）· Kotlin Multiplatform + Compose
...
- **沉浸浏览** — 全屏模式与删除预览支持双指捏合缩放、双击放大与平移，看清细节再决定去留
- **安全删除** — 浏览时仅标记，结果页统一确认，支持反悔
- **清理成果** — 统计页展示累计清理量、连续清理天数、月度回顾与里程碑徽章，结果页随场景送上励志文案；全程离线、记录仅存本机
